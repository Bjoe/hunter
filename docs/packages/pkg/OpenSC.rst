...
-  `Example <https://github.com/ruslo/hunter/blob/master/examples/OpenSC/CMakeLists.txt>`__
-  Added by `foo_developer <https://github.com/foo_developer>`__ (`pr-N <https://github.com/ruslo/hunter/pull/N>`__)

.. literalinclude:: /../examples/OpenSC/CMakeLists.txt
  :language: cmake
