...
-  `Example <https://github.com/ruslo/hunter/blob/master/examples/nettle/CMakeLists.txt>`__
-  Added by `foo_developer <https://github.com/foo_developer>`__ (`pr-N <https://github.com/ruslo/hunter/pull/N>`__)

.. literalinclude:: /../examples/nettle/CMakeLists.txt
  :language: cmake
